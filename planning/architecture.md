...
- Firestore Security Rules **and `firestore.indexes.json`** deploy via the Firebase CLI — `firebase deploy --only firestore` covers both (§3; README, "Deploying Firestore rules and indexes"). No Functions to deploy.
